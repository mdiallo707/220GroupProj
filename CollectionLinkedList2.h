...
class CollectLinkedList2: public CollectPlaylists {
private:
    CollectLinkedNode2* front;
    int currCount;
public:
    /**
     * Constructor
    ...
    CollectLinkedList2(const CollectLinkedList2& arrayListToCopy);

    void addPlaylist(PlaylistLinkedQueue aPointerIn);
};
